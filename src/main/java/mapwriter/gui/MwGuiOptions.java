...
public class MwGuiOptions extends GuiScreen {
	...
	public void initGui() {
        ...
        this.buttonList.add(new GuiButton(200, (this.width / 2) - 50, this.height - 28, 100, 20, "Hecho"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Opciones del Mapa", this.width / 2, 10, 0xffffff);
